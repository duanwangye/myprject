...
class Subject extends Base
{
    ...
    public function getSubjectList() {
        ...
        foreach ($list as $k=>$item) {
            $list[$k]['contentUrl1'] = $this->h5RootUrl().'/'.$this->request->module().'/h5/subjectContent?tab=1' . '&######';
            $list[$k]['contentUrl2'] = $this->h5RootUrl().'/'.$this->request->module().'/h5/subjectContent?tab=2' . '&######';
            $list[$k]['contentUrl3'] = $this->h5RootUrl().'/'.$this->request->module().'/h5/subjectContent?tab=3' . '&######';
    ...
    public function getSubjectDetail() {
        ...
        $item['contentUrl1'] = $this->h5RootUrl().'/'.$this->request->module().'/h5/subjectContent?tab=1' . '&######';
        $item['contentUrl2'] = $this->h5RootUrl().'/'.$this->request->module().'/h5/subjectContent?tab=2' . '&######';
        $item['contentUrl3'] = $this->h5RootUrl().'/'.$this->request->module().'/h5/subjectContent?tab=3' . '&######';
        return Common::rm(1, '操作成功', [
            'subjectDetail'=>$item
        ]);
    }
