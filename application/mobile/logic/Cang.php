...
class Cang extends Base
{
    ...
    public function create()
    {
        ...
        //如果是T + 1，我们容易计算利息
            ...
            if(Subject::getOvertimeIsinterest() == 1) {
    ...
    public function getCangList() {
        ...
        $list->append(['statusText','repayTimeText'])->visible(['cangID','moneySubject','payTime','status','investDay','interestBeginTime','interestEndTime','year','yearExt','yearSystem','interest','ben','repayBenTime','subject'=>[
        ...
        foreach ($list as $k=>$item) {
            if($item['cangRepay']) {
                $list[$k]['repayTime'] = $item['cangRepay'][0]['repayTime'];
            }
        }
