...
<script src="{$Think.config.base_url}/static/admin/js/content.min.js?v=1.0.0"></script>
<script src="{$Think.config.base_url}/static/admin/js/plugins/flot/jquery.flot.js"></script>
<script src="{$Think.config.base_url}/static/admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="{$Think.config.base_url}/static/admin/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="{$Think.config.base_url}/static/admin/js/plugins/chartJs/Chart.min.js"></script>
<script src="{$Think.config.base_url}/static/admin/js/plugins/peity/jquery.peity.min.js"></script>
<script src="{$Think.config.base_url}/static/admin/js/demo/peity-demo.min.js"></script>
